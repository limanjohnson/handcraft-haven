    ...
    <div className="p-8 max-w-5xl mx-auto">
      ...
      {product.artisan_name && (
        <div className="mt-6 border-t pt-4">
          ...
          {product.artisan_email && <p className="text-gray-500">{product.artisan_email}</p>}
        </div>
      )}
      ...
      {related.length > 0 && (
        <div className="mt-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {related.map((rel) => (
              <div key={rel.id} className="border rounded-lg p-4 shadow hover:shadow-lg transition">
                {rel.image_url ? (
